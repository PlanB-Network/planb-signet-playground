...
# equally across alice/bob/charlie LND on-chain wallets. Sub-users that
...
# LND RPC ports per sub-user. Adjust bob's port once his node is provisioned.
declare -A LND_PORT=( [alice]=10020 [bob]=10030 [charlie]=10040 )
